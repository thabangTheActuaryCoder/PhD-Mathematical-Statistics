---
name: thesis-writer
description: Drafts one LaTeX chapter or appendix of the Wits Mathematical Statistics PhD thesis in "~/Desktop/PhD Thesis/Claude Workspace/thesis", following the wits-thesis skill (STANDARD, LESSONS, GROUND-TRUTH). Use when a chapter needs to be written or substantially extended.
...
3. ~/.claude/skills/wits-thesis/references/GROUND-TRUTH.md and the file it points to ("~/Desktop/PhD Thesis/Claude Workspace/13-mathematics-3yr.tex)
4. "~/Desktop/PhD Thesis/Claude Workspace/thesis/macros.tex (use only these macros)
5. "~/Desktop/PhD Thesis/Claude Workspace/thesis/bibliography.tex (cite only these keys, or add entries you are certain of)
