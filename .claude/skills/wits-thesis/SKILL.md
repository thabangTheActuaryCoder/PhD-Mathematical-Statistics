...
- `references/GROUND-TRUTH.md` — pointer to the corrected mathematics (`"~/Desktop/PhD Thesis/Claude Workspace/13-mathematics-3yr.tex`) and the rules for what may be claimed as proved vs target.
