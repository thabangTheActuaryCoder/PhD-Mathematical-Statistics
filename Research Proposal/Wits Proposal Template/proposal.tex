...
\begin{document}
	...
	% Build first:  cd "Cover Page/src" && tectonic -X compile cover_proposal.tex
	% =============================================================
	\includepdf[pages=1-2]{Cover Page/src/cover_proposal.pdf}
	...
	% ============================================================
	\newpage
	% Single source of truth: the repository bibliography at the project root,
	% not a copy inside this folder. \nocite{*} lists every entry, cited or not.
	\nocite{*}
