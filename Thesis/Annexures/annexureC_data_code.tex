...
\section{USD data}\label{sec:appC-usd}\input{Thesis/Annexures/appC-usd-data}
\section{ZAR data}\label{sec:appC-zar}\input{Thesis/Annexures/appC-zar-data}
\section{Code architecture}\label{sec:appC-code}\input{Thesis/Annexures/appC-code}
